...
2. **Module naming with SHA1** — For deterministic, collision-resistant naming outside of Rollup's asset pipeline. This is mainly necessary for esbuild and maybe rspack - for Rollup and Rolldown, the asset pipeline handles this.
